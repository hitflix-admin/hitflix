...
function WinnerHint({ hintCategory }) {
  ...
  return (
    ...
    >
      <Trophy size={20} strokeWidth={1.8} color={COLORS.caramel} style={{ flexShrink: 0 }} />
      <div style={{ fontSize: 13.5, lineHeight: 1.4 }}>
        This movie won an Oscar for <span style={{ fontWeight: 700, color: COLORS.caramel }}>{hintCategory}</span>.
      </div>
    </div>
  );
}
