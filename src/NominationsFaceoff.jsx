...
export default function NominationsFaceoff() {
  return (
    <FaceoffGame
      ...
      pageTitle="Hitflix — Faceoff (Oscars Edition)"
      heading="Faceoff (Oscars Edition)"
      description="Which movie got more Oscar nominations? 5 rounds, similar genres each time."
      shareLabel="Hitflix Faceoff (Oscars Edition)"
      shareUrl="https://hitflix.club/nominations-faceoff"
